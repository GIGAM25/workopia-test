<x-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <section class="md:col-span-3">
            <div class="rounded-lg shadow-md bg-white p-3">
                ...
                <div class="p-4">
                    ...
                    <ul class="my-4 bg-gray-100 p-4">
                        ...
                        <li class="mb-2">
                            <strong>Salary:</strong> P{{number_format($job->salary)}}
                        </li>
                        <li class="mb-2">
            ...
            <div class="container mx-auto p-4">
                    ...
                    <div x-cloak x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900/50">
                        <div @click.away="open=false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                            ...
                            <form method="POST" action="{{route('applicant.store', $job->id)}}" enctype="multipart/form-data">
                                @csrf
                                {{-- :required with colon mean it's boolean --}}
                ...
                <p class="my-5 bg-gray-200 rounded-xl p-3">
                    <i class="fas fa-info-circle mr-3"></i> You must be log in to apply for this job
                </p>
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            {{-- bookmark button  --}}
            {{-- <a href="" class="mt-10 bg-blue-500 hover:bg-blue-600 text-white font-bold w-full py-2 px-4 rounded-full flex items-center justify-center"><i class="fas fa-bookmark mr-3"></i> BookmarkListing</a> --}}
            @guest 
