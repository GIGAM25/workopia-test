<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{route('jobs.update', $job->id)}}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="state" name="state" label="State" placeholder="PH" :value="old('state', $job->state)" />

            <x-inputs.text id="zipcode" name="zipcode" label="Zip Code" placeholder="1268" :value="old('zipcode', $job->zipcode)" />
            ...
            <x-inputs.text id="contact_email" name="contact_email" label="Contact Email" placeholder="Email where you want to receive applications" type="email" :value="old('contact_email', $job->contact_email)" />
